...
import type {BaseSchema, BaseSchemaAsync, Input, Output} from 'https://deno.land/x/valibot@v0.17.0/mod.ts';
...
export const fetchModule = /* @__PURE__ */ memoize(async () => {
  const {safeParseAsync} = require('valibot') as typeof import('https://deno.land/x/valibot@v0.17.0/mod.ts');
