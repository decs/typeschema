...
## Dependencies
- [`@effect/schema`](https://www.npmjs.com/package/@effect/schema): Required for inference and validation (`^0.60.6`)
- [`effect`](https://www.npmjs.com/package/effect): Required for inference and validation (`^2.1.2`)
